...
namespace JacobHomanics.UI.Editor
{

    [CustomEditor(typeof(TrickedOutImage))]
    [CanEditMultipleObjects]
    public class TrickedOutImageEditor : UnityEditor.Editor
    {
        private TrickedOutImage trickedOutImage;

        // Serialized Properties
        private SerializedProperty connectorProp;
        ...
        private static readonly System.Collections.Generic.Dictionary<string, string> AvailableFeatures = new System.Collections.Generic.Dictionary<string, string>
    {
        ...
        {
            trickedOutImage = (TrickedOutImage)target;

            // Find all serialized properties
            connectorProp = serializedObject.FindProperty("connector");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("Tricked Out Image", EditorStyles.boldLabel);
            EditorGUILayout.Space();
            ...
            if (showReferences)
            {
                ...
                EditorGUILayout.PropertyField(connectorProp, new GUIContent("Connector"));
